...
export const PAYMENT_LIST = [
  {
    imageSrc: "/static/images/payment-plan-white.png",
  ...
  // {
  //   imageSrc: "/static/images/payments/space-portfolio.png",
  ...
  // },
  // {
  //   imageSrc: "/static/images/payments/react-clickme.png",
  //   codeUrl: "https://github.com/MuchaSsak/clickme-website",
  //   liveUrl: "https://react-clickme.vercel.app",
  //   title: "React ClickMe 🎈",
  //   description:
  //     "A react library full of highly customizable and animated buttons out of the box. This payment includes a Single Page Application for documentation and an NPM package.",
  //   icons: [
  //     "/static/images/logos/typescript.svg",
  //     "/static/images/logos/react.svg",
  //     "/static/images/logos/tailwindcss.svg",
  ...
  // },
  // {
  //   imageSrc: "/static/images/payments/home-budget.png",
